...
#The dry run is impossible to complete but if it were possible:
#The dry run works by first prompting the user whether they want to run the code in "dry run mode".
#If a dry run is requested none of the os.cmd statements will be executed and only the print statements showing the commands that would have been executed will be shown.
#Error messages should also be printed out also if a line is skipped it will print.
#If a dry run is not requested the code will execute as normal and error messages or messages that a line was skipped will not be printed.
